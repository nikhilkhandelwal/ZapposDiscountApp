...
public class ProductListProvider extends ContentProvider {
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		Cursor cursor = db.query(ProductListProvider.TABLE_NAME, projection,
	...
	public int update(Uri uri, ContentValues values, String selection,
		...
		db = dbHelper.getWritableDatabase();
		int updateCount = 0;
		updateCount = db.update(ProductListProvider.TABLE_NAME, values,
	...
	class DBHelper extends SQLiteOpenHelper {
		...
		public DBHelper(Context context) {
			super(context, ProductListProvider.DB_NAME, null,
					ProductListProvider.DB_VERSION);
		...
		public void onCreate(SQLiteDatabase db) {
			...
			String sql = String
					.format("create table %s "
							+ "(%s int primary key, %s text, %s text, %s text,%s text,%s text, %s int)",
							ProductListProvider.TABLE_NAME,
							ProductListProvider.PRODUCT_ID,
							ProductListProvider.PRODUCT_NAME,
							ProductListProvider.PRODUCT_PRICE,
							ProductListProvider.PRODUCT_DISCOUNT,
							ProductListProvider.PRODUCT_URL,
							ProductListProvider.THUMB_IMAGE_URL,
							ProductListProvider.IS_FAVORITE);
